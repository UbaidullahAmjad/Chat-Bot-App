            ...
            <div class="card">
              ...
              <?php
                if(isset($_POST['save'])){
                       ...
                       $del=mysqli_query($con,"delete from hashtags where user_id='$id'");
                       
                       if($del){
                         
                         $file = "../".$commentfolder;
                         $handle = fopen($file, "r");
                         $read=fread($handle,filesize("../".$commentfolder));
                         $print=explode("$",$read);
                         $x=sizeof($print);
                     
                         for($i=0 ; $i<$x; $i++){
                             $insert=mysqli_query($con,"insert into hashtags values (null,'$id','$print[$i]',0)");
                         }
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <input type="submit" class="btn btn-primary" value="Likes" name="get" >

              </form>
              <?php
                if(isset($_POST['get'])){
                    $ouput=exec("D:\\python\\instabot\\Likes.py");
              ...
              ?>
                <table id="example2" class="table table-bordered text-center table-hover">
                  ...
                  <tbody>
                      <?php
                      $select=mysqli_query($con,"select * from hashtags where user_id='$id'");
                      if($select){
                 ...
                 <tr>
                   ...
                   <?php
                        if($row['active']==0){
                            ?>
                            <td style="text-align:center;"><input type="checkbox" name="activate" value="1"  onclick="location.href='check.php?tid=<?php echo $row['id']?>&uid=<?php echo $id ?>';"/> </td>
                            <?php
                        }else{
                            ?>
                             <td style="text-align:center;"><input type="checkbox" name="activate" value="1" checked onclick="location.href='uncheck.php?tid=<?php echo $row['id']?>&uid=<?php echo $id ?>';"/> </td>
                            <?php
                        }
                   ?>
