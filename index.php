<?php
	...
	if(isset($_POST['login'])){
		...
		$query=mysqli_query($con,"select * from admin where admin_name='$username' and admin_password='$password'");
		if($query){
				...
				<div class="login100-form validate-form">
                  ...
                  <form method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="admin_name" placeholder="Email">
