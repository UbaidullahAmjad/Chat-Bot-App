...
class InstagramBot:
    ...
    def like_photo(self, hashtag):
        ...
        for pic_href in pic_hrefs:
            ...
            driver.execute_script("window.scrollTo(0, document.body.scrollHeight);")
            try:
                x=driver.find_element_by_xpath('/html/body/div[1]/section/main/div/div[1]/article/header/div[2]/div[1]/div[1]/div/a').text
                #print(x)
                ...
                #commentArea.click()
                commentArea = driver.find_element_by_xpath('/html/body/div[1]/section/main/div/div[1]/article/div[3]/section[3]/div/form/textarea')
                commentArea.send_keys("@" + x + " Nice pic dear")
                time.sleep(2)
